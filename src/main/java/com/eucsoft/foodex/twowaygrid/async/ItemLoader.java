 ...
 * in {@link org.lucasr.smoothie.AsyncListView} or {@link org.lucasr.smoothie.AsyncGridView}. This is the class
 * you should subclass to implement your app-specific item loading
 * and displaying logic.
 * <p/>
 * <p>You should use {@link org.lucasr.smoothie.SimpleItemLoader} if your
 * {@link org.lucasr.smoothie.AsyncListView} or {@link org.lucasr.smoothie.AsyncGridView} only needs one
 ...
 * {@link #displayItemPart(android.view.View, Object, int, boolean)}, and
 * {@link #getItemParams(android.widget.Adapter, int)}.</p>
 * <p/>
 ...
 * </pre>
 * <p/>
 * <p>The ItemLoader should be passed to {@link org.lucasr.smoothie.ItemManager.Builder Builder} constructor:</p>
 * <pre>
 ...
 * which will be sent to {@link #displayItemPart(android.view.View, Object, int, boolean)}.</li>
 * </ol>
 * <p/>
 * <h2>The 4 steps</h2>
 * <p>When an ItemLoader is in action, each item will go through 4 steps:</p>
 * <ol>
 * <li>{@link #getItemParams(android.widget.Adapter, int)}, invoked on the UI thread before the
 ...
 * <li>{@link #displayItemPart(android.view.View, Object, int, boolean)}, invoked on the UI thread
 * after the item part finishes loading.</li>
 * </ol>
 * <p/>
 * <h2>Multi-part items</h2>
 * <p>There are cases where the items of your {@link org.lucasr.smoothie.AsyncListView} or
 * {@link org.lucasr.smoothie.AsyncGridView} are composed by more than one part requiring multiple
 ...
 * <p/>
 * <p>By default, {@link com.eucsoft.foodex.twowaygrid.async.ItemLoader} handles single-part items but you can
 * make it handle multi-part items by overriding
 * {@link #getItemPartCount(android.widget.Adapter, int, int)} and returning the number of parts
 ...
 * {@link #loadItemPart(Object, int)}, and {@link #displayItemPart(android.view.View, Object, int, boolean)}
 ...
 * If your item contains parts with different types, your {@link com.eucsoft.foodex.twowaygrid.async.ItemLoader}'s {@code Result}
 ...
 * {@link #shouldPreloadItemPart(android.widget.Adapter, int, int)}. Preloading is enabled for
 * all item parts by default.
 * <p/>
 * <h2>ItemLoader and Adapter</h2>
 * <p>Once you have an {@link org.lucasr.smoothie.ItemManager} set in an {@link org.lucasr.smoothie.AsyncListView} or
 * {@link org.lucasr.smoothie.AsyncGridView}, your Adapter will behave exactly the same. In your
...
public abstract class ItemLoader<Params, Result> {
    ...
    /**
     * Override this method if your {@link com.eucsoft.foodex.twowaygrid.async.ItemLoader} has to deal with
     * multi-part items.
     *
     * @param adapter  - The {@link android.widget.Adapter} associated with the target
     *                 {@link org.lucasr.smoothie.AsyncListView} or {@link org.lucasr.smoothie.AsyncGridView}.
     ...
     * preloaded or not.
     * @see org.lucasr.smoothie.ItemManager.Builder#setPreloadItemsEnabled(boolean)
     */
     ...
     *                   {@link #getItemParams(android.widget.Adapter, int)}.
