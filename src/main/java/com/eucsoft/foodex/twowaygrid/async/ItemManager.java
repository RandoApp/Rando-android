 ...
 * item selection, etc) on the target {@link org.lucasr.smoothie.AsyncAbsListView}
 * with its associated {@link org.lucasr.smoothie.ItemLoader}. Once an ItemManager
 * is set on an {@link org.lucasr.smoothie.AsyncAbsListView}, the {@link org.lucasr.smoothie.ItemLoader}
...
public final class ItemManager {
    ...
    private void updateItems() {
        ...
        final TwoWayAbsListView absListView = mManaged.getAbsListView();
    ...
    void setItemManaged(ItemManaged itemManaged) {
        ...
        if (mManaged != null) {
            final TwoWayAbsListView twoWayListView = mManaged.getAbsListView();

            // These listeners will still run the current list view
            // listeners as delegates. See ItemManaged.
            twoWayListView.setOnScrollListener(new ScrollManager());
            twoWayListView.setOnTouchListener(new FingerTracker());
            /*twoWayListView.setOnItemSelectedListener(new SelectionTracker());*/
        }
    }
    ...
    private class ScrollManager implements TwoWayAbsListView.OnScrollListener {
        @Override
