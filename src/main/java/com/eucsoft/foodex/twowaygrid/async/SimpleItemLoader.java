...
/**
 * {@code SimpleItemLoader} is an {@link org.lucasr.smoothie.ItemLoader} specialised in loading and
 * displaying single-part items in {@link org.lucasr.smoothie.AsyncListView} or {@link org.lucasr.smoothie.AsyncGridView}.
 * It simply hides all the item part elements of the {@link org.lucasr.smoothie.ItemLoader} API as
 * they are not needed on single-part items.
 * <p/>
 * <p>You should use {@link org.lucasr.smoothie.ItemLoader} if your {@link org.lucasr.smoothie.AsyncListView} or
 * {@link org.lucasr.smoothie.AsyncGridView} contains multi-part items i.e. needs more than one
 * asynchronous loading operation per item.</p>
 * <p/>
 * <p>Refer to the {@link org.lucasr.smoothie.ItemLoader} for more detailed documentation on the API.</p>
 *
